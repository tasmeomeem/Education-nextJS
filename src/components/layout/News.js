...
const Hero = () => {
    return (
        <div className="pb-10">
            ...
            <div> 
                <div className="text-center justify-center items-center relative text-center bg-gray-300 pt-10 px-2">
                    <input
                        type="text"
                    ...
                    <button className="mt-5 btn bg-blue-500 btn-primary sm:mt-0 sm:ml-2 mb-8">Subscribe<FaArrowRight /></button>
                </div>
